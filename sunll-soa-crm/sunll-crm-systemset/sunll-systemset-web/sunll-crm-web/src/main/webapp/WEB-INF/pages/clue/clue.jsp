...
<div id="container" class="wrap animated fadeInRight" v-cloak>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <%--<permissionsCode:hasPermissions permissionsCode="customer:add" CRM_TOKEN="${cookie.permissionsKey.value}">--%>
        ...
        <div class="row m-b">
            <div class="col-xs-6">
                <button :disabled="have" class="btn btn-outline btn-primary m-r-sm smsY" type="button">
                    ...
                    <span data-toggle="modal"  data-target="" class="smsShow">短信批发</span>
                    <%--批发短信--%>
                </button>
            ...
            <table class="table table-custom table-blue-bg">
                ...
                <tr>
                    <th class="po-rela dropdown w120">
                        <input type="checkbox" :checked="isAllSelected" class="checkboxAll" id="checkboxAll"
                        ...
                        <table class="table table-hover table-custom">
                            ...
                            <tr v-for="item, index in filtedData">
                                <td class="w120"><input :id="item.filedId" type="checkbox"
                                                        ...
                                                        @change="changeItem($event, item, index)" class="iptcheckbox"/>
                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="clearfix">
                            <label class="checkbox-inline col-sm-4" for="r1">
                                <input type="radio" id="r1" name="phone" value="1">
                                覆盖导入
                            </label>
                    ...
                    <div class="form-group-lg">
                        <label class="form-title">请选择要导入的XLE文件</label>
                        <div class="error" style="margin-top: 20px;color: #ff0000;display:none;" id="errorId">
                            部分数据导入失败，<a href="#" style="text-decoration: underline;color:#ff0000;" id="errorMessageExcel">查看原因</a>
                        </div>
    ...
    <div class="mask" id="maskId">
       <div class="font">线索禁用，请联系管理员</div>
    </div>
</div>
</body>
