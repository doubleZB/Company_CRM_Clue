        ...
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown" onMouseOver="displaySubMenu('fg')" onMouseOut="hideSubMenu('fg')">
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            updateMmsOneShow: function () {
                alert("mmsId:" + vm.messageId + ",clueId:" + vm.identifyId + ",businessTypeId:" + vm.businessTypeId);
                $.ajax({
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log("sessionstorage中的数据，分机号：" + sessionStorage.getItem("USER_TELEPHONE") + ",手机号：" +
                        sessionStorage.getItem("USER_MOBILE") + ",主机号：" + sessionStorage.getItem("COMPANY_TELEPHONE"));
            }
        });
    });
    //弹框
                ...
                success: function (data) {
                    ...
                    if (data.data != null && data.data != "") {
                        if (data.data.length != 0) {
                            ...
                            console.log("" + data.data[0].smsText + ",跟进时间:" + data.data[0].smsDateShow + ".");
                            $("#winpop").show();
                            show1();
                        }
                    }
