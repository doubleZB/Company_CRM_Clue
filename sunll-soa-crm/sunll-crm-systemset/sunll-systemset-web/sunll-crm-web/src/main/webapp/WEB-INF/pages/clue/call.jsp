        ...
        <div class="col-lg-12 white-bg">
            <div class="col-md-6 form-inline m-t-n m-b-sm">
                ...
                <p class="pull-left m-l-sm m-t-sm">
                    {{contactName}} <%--<b class="status text-navy">通话中</b>--%>
                    <br>
                    {{phone}}
                </p>
                <select v-if="isShowFollowStatus==1" class="form-control m-l m-t-sm" v-model="showFollowStatus" @change="changeFollowStatus">
                        ...
                        <div class="ibox-content col-md-10">
                            <template v-for="item in followRecord.followRecordList">
                                ...
                                <div class="contentFooter clearfix">
                                    来源：<b>线索</b>
                                    <p class="pull-right">
                                        <span class="cursor-pointer text-danger" @click="delFollowRecord(item.id)"><i class="fa fa-trash-o"></i> 删除</span>
                                        <%--&nbsp;|&nbsp;
