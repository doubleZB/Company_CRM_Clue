        ...
        function getData(arr) {
            ...
            if (arr.department == "" && arr.person == "") {
                ...
                for (var i = 0; i < arr.person.length; i++) {
                    ...
                    var _html = '<li class="addCont"><input type="checkbox" class="checkboxBtn fr findCheck" id="'+ arr.person[i].id + '" status="2"/><a href="###" class="fr"><span class="fl contTxt" style="background:' + arrColor[ColorIndex] + '">' + ColorName + '</span><div class="fl"><p class="num_name">' + arr.person[i].name + '</p><p class="desc"></p></div></a></li>';
                    $(".person").append(_html);
                }
            }
