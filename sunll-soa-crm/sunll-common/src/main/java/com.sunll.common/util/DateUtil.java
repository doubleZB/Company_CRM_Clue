...
public class DateUtil {
     ...
     * 文件名中的无连接符的时间，精确到毫秒
     */
    public static final String FILE_TIME_FORMAT = "yyyyMMddHHmmssSSS";
     ...
     * @return
     */
    public static String Date2StringZZZ(Date date) {
        return Date2String(date, SQL_TIME_FMT, null);
    }
...
//        System.out.println(date1+" -- "+date2+" 相差多少"+u[stype]+":"+n);         
    ...
    /**
     * 获取yyyyMMddHHmmssSSS格式的当前时间，多用于文件名中
     *
     * @return 20170310085410851
     * @author zhangyu
     */
    ...
    public static Date stringToDate(String dateStr) {
        SimpleDateFormat sdf = new SimpleDateFormat(YYYYMMDDFMT);
        try {
            return sdf.parse(dateStr);
        } catch (ParseException e) {
            e.printStackTrace();
...
//        System.out.println(stringToDate("2016-02-04"));
//    }
}