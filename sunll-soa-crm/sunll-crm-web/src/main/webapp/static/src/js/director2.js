        ...
        function getData(arr) {
            ...
            if (arr.department == "" && arr.person == "") {
                ...
                for (var i = 0; i < arr.department.length; i++) {
                    var _html = '<li class="parentNode addCont"><a href="javascript:;" class="fr" id="' + arr.department[i].id + '"><span class="z_fl lineHeight100">' + arr.department[i].name + '</span><span class="z_fr"><i class="fa fa-angle-right fa-2x"></i></span></a></li>';
                    $(".department").append(_html);
                }
                for (var i = 0; i < arr.person.length; i++) {
                    if(sessionStorage.getItem("USER_TOKEN") != arr.person[i].id){
