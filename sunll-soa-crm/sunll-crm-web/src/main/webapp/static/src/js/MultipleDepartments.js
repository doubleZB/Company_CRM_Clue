...
var UNITE_ACCOUNT_BASE_URL = $("#UNITE_ACCOUNT_BASE_URL").val();
var vm = new Vue({
    el: "#content",
    data: {
        have:true,
...
function selectDepartment() {
    ...
    var layerIndex;
    $.ajax({
        url: UNITE_ACCOUNT_BASE_URL+"/interfaceTrans/selectDepartment",
        type: 'POST',
        async: false,
...
function listDepartmentByPid() {
    ...
    var layerIndex;
    $.ajax({
        url: UNITE_ACCOUNT_BASE_URL+"/interfaceTrans/listDepartmentByPid",
        type: 'POST',
        async: false,
        data: JSON.stringify(data),
        dataType: "json",
...
function listDepartmentPage() {
    ...
    var layerIndex;
    $.ajax({
        url: UNITE_ACCOUNT_BASE_URL+"/interfaceTrans/listDepartmentPage",
        type: 'POST',
        async: false,
        data: JSON.stringify(data),
        dataType: "json",
