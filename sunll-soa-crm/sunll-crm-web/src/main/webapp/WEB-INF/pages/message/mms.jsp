            ...
            <div class="ibox">
                ...
                <div class="ibox-content form-inline">
                    <div class="form-group m-r">
                        ...
                        <select class="form-control" id="selectServiceScene" @change="fnChangeServiceScene"
                                v-model="serviceSceneStr">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button @click="sendOther()" :disabled="userStatus" type="button"
                    ...
                    <%--<button class="form-group" @click="query()">查询</button>--%>
                    <button type="button" class="form-group" @click="query()">查询</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="full-height-scroll">
                        <table class="table table-striped table-hover table-custom">
                            ...
                            <tr v-for="item in operate">
                                ...
                                <td class="li1" onmouseover="this.className='li2'" onmouseout="this.className='li1'">{{item.smsContent}}</td>
                                ...
                                <td>
                                    ...
                                    <span data-toggle="modal" data-target="#smsModule" class="text-danger"
                                          @click="sendMessagesBySendContentTem(item.sendContentTem,item.id)">重发</span>
                                </td>
                            </tr>
                            </tbody>
                        </table>
            ...
            <div class="row p-sm form-inline page">
                <div class="col-sm-12 text-right">
                    <div class="inline m-r">
                        ...
                        <select class="input-sm form-control input-s-sm" id="checkedPageSize"
                                v-on:change="checkedPageSize($event)">
                            <option v-for="item in pageSizeField" :value="item">{{item}}</option>
                        </select>
                        <label class=" control-label m-r">条，共{{total}}条</label>

                        <a class="btn btn-white btn-sm btn-bitbucket" @click="lastPage()"><i
                                class="fa fa-caret-left"></i></a>
                        <label class="control-label">{{pageNum}} / {{pages}}</label>
                        <a class="btn btn-white btn-sm btn-bitbucket" @click="nextPage()"><i
        ...
        <%--<div class="modal-dialog">--%>
            <%--<div class="modal-content">--%>
                ...
                <%--<div class="modal-footer">--%>
                    <%--<button type="button" class="btn btn-primary" @click="sendMessages()">发送</button>--%>
