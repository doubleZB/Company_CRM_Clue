...
<div id="BusinessType">
    <div class="header_top">
        ...
        <%--<permissionsCode:hasPermissions permissionsCode="sms_tem:add" CRM_TOKEN="${cookie.permissionsKey.value}">--%>
    ...
    <div class="table_box" style="margin-top:0;">
        <table >
            ...
            <tr v-for="item in smsTemList">
                <td>{{item.name}}</td>
                <td class="li1" onmouseover="this.className='li2'" onmouseout="this.className='li1'">{{item.content}}</td>
    ...
    <div class="AddTape">
        ...
        <div>
            ...
            <input type="text" class="form-control input-sm __web-inspector-hide-shortcut__" name="search" id="smsTemName"
                   placeholder="请输入业务类型,最长10个字符" maxlength='10'>
        </div>
        <div>
        ...
        <div>
            ...
            <textarea id="smsTemContent" style="width: 330px; height: 150px;"
                      placeholder="请输入短信内容，280字符内" rows="5" class="form-control input-sm __web-inspector-hide-shortcut__" maxlength='280'></textarea>
        </div>
        <div>
            <span class="pull-left">测试手机</span>
            <input type="text" class="form-control input-sm __web-inspector-hide-shortcut__" name="search" id="smsTemTest" maxlength='11'
