        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <!-- 导出数据 -->
                    <form id="exf" action="/call/exportTimeStatisticsTotalOther" method="post">
                    ...
                    <div class="full-height-scroll">
                        <table class="table table-striped table-hover table-custom">
                            ...
                            <tr v-for="row in operate">
                                ...
                                <td >{{row.name}}</td>
                                <td >{{row.outCallNumber}}</td>
                                <td >{{row.outCallSuccessNumber}}</td>
                                <td >{{row.outCallFailNumber}}</td>
                                <td >{{row.outCallSuccessRate}}%</td>
                            ...
                            <tr class="text-navy">
                                ...
                                <td>总计</td>
                                <td >{{allTotal.outCallNumber}}</td>
                                <td >{{allTotal.outCallSuccessNumber}}</td>
                                <td >{{allTotal.outCallFailNumber}}</td>
                                <td >{{allTotal.outCallSuccessRate}}%</td>
                                <td >{{allTotal.conversionRate}}%</td>
...
<script src="${pageContext.request.contextPath}/static/src/js/statistic-duration.js"></script>
</html>