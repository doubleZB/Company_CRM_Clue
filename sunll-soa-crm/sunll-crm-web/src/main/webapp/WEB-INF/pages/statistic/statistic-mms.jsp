        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-title">
                    ...
                    <!-- 导出数据 -->
                    <form id="exf" action="/message/exportMessageUserTogetherTotal" method="post">
                    ...
                    <div class="full-height-scroll">
                        <table class="table table-striped table-hover table-custom">
                            ...
                            <tr v-for="row in operate">
                                ...
                                <td >{{row.arrivalNumber}}</td>
                                <td >{{row.totalExpenses}}</td>
                            </tr>
                            <tr class="text-navy">
                                <td style="display: none">ID</td>
                                <td>总计</td>
                                <td >{{allTotal.sendNumber}}</td>
                                <td >{{allTotal.arrivalNumber}}</td>
                                <td >{{allTotal.totalExpenses}}</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
<script src="${pageContext.request.contextPath}/static/src/js/statistic-mms.js"></script>
</html>