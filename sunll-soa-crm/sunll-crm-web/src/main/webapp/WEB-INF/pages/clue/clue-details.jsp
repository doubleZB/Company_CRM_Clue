        ...
        <div class="col-lg-12 white-bg ibox">
            <div class="ibox-title">
                ...
                <div class="col-md-6 form-inline text-right m-b-sm">
                    ...
                    <permissionsCode:hasPermissions permissionsCode="clue:tostore" CRM_TOKEN="${cookie.permissionsKey.value}">
                    ...
                    <permissionsCode:hasPermissions permissionsCode="clue:update" CRM_TOKEN="${cookie.permissionsKey.value}">
                    ...
                    <permissionsCode:hasPermissions permissionsCode="clue:speech" CRM_TOKEN="${cookie.permissionsKey.value}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control selectCheck" v-model="showPointStore" <%--@change="savePointStore()"--%>>
                                <option v-for="item in pointStore" :value="item.value">{{ item.name }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary selMen" @click="savePointStore()">确定</button>
