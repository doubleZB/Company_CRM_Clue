...
<div id="content" v-cloak>
    ...
    <div class="content">
        ...
        <table v-for="item in todos" class="tab taBb">
        ...
        <div class="editFieldTxt positionCont">
            ...
            <div class="posttio" style="z-index: 3;">
             ...
             <div style="overflow: auto">
                 ...
                 <div v-if="fieldType=='checkbox'" class="selectTxt">
                     ...
                     <div class="clearB Example">
                         ...
                         <%--<select class="form-control selectList">--%>
                             <%--<option v-for="item in selectList">{{item}}<span @click="delSelectList($index)" @click="del(2,$index)">×</span></option>--%>
                         <%--</select>--%>
                     </div>
                 </div>
