...
<html>
	...
	<body id="content" v-cloak>
		<div class="wrap">
			...
			<div class="main">
				<div class="mainLeft">
					<p><i class="fa fa-search"></i><input :disabled="have" type="text" placeholder="请输入部门名称查询" id="departmentName" class="search"/></p>
					<div class="selectAll">
    ...
    <input type="hidden" id="UNITE_ACCOUNT_BASE_URL" value="${UNITE_ACCOUNT_BASE_URL}">
	</body>
</html>
